...
?>
<div class="wpmud-system-info"></div>
<section id="wpmud-login" class="wpmud-login">
	<div id="wpmud-login-box" class="wpmudui-box is-sm is-center is-login">
		<section class="wpmudui-box__main">
			<h2 class="wpmudui-brand-title"><?php esc_html_e( 'Connect Cloudngin Pro', 'wpmudev' ); ?></h2>
			<p><?php esc_html_e( 'Log in using your Cloudngin Pro WPMU account email and password.', 'wpmudev' ); ?></p>
				...
				<div class="wpmudui-form-cta-fields">
					<div class="wpmudui-form-cta__item is-left">
						<p class="wpmudui-form-note">
							<?php
							printf(
								esc_html__( 'Need a Cloudngin Pro? %sSign up%s today!', 'wpmudev' ),
								'<a href="http://www.cloudngin.com/plans" target="_blank">',
								'</a>'
							);
							?>
						</p>
